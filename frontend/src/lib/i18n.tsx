...
const ja: Dict = {
  ...
  vibration: 'バイブ',
  notifications: '通知',
  notifyReminderTitle: 'ちずぬりえ',
  notifyReminderBody: '今日もまちを歩いて地図を塗ろう！',
  notifyEnabledTitle: '通知をオンにしました',
  notifyEnabledBody: '毎日朝8時にリマインドします。',
  notifyRecoveryTitle: 'ちずぬりえ',
  notifyRecoveryBody: '塗りポイントが全回復しました！まちを塗りに行こう。',
  notifyDenied: '通知が許可されていません。端末の設定から通知を許可してください。',
  mapDisplay: '地図表示',
...
const en: Dict = {
  ...
  notifyReminderTitle: 'Chizunurie',
  notifyReminderBody: 'Take a walk and paint more of the map today!',
  notifyEnabledTitle: 'Notifications on',
  notifyEnabledBody: "We'll remind you every day at 8 AM.",
  notifyRecoveryTitle: 'Chizunurie',
  notifyRecoveryBody: 'Your paint points are full! Time to go paint the map.',
  notifyDenied: 'Notifications are not allowed. Please enable them in your device settings.',

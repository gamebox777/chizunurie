// Cloudflare Worker: apex（unitygamebox.com）の /ads.txt を「実体200」で直接返す。
//
// 背景: AdSense の所有権確認は apex unitygamebox.com/ads.txt を見にくる。
// apex はアプリ本体を配信していない（サブドメイン chizunurie.unitygamebox.com が本体）ため、
...
//   2. Worker の Settings → Triggers → Routes に  unitygamebox.com/ads.txt  を追加（Zone: unitygamebox.com）。
...
//
// 確認:  curl -sI https://unitygamebox.com/ads.txt  が 200 / text/plain で 1 行返ればOK。
